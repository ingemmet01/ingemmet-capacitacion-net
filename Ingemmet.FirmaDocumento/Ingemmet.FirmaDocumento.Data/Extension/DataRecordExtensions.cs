namespace System.Data
{
    ...
    public static class DataRecordExtensions
    {
        ...
        /// type or is <c>null</c>; a <see cref="InvalidCastException"/> will be thrown. 
        /// </remarks> 
        public static byte[] GetByteArray(this IDataRecord dataRecord, String column)
        {
            return (byte[])dataRecord[column];
        }
        ...
        /// <summary>
        /// Devuelve true si el campo especificado se establece en null o udefained.
        /// </summary>
        /// <param name="dataRecord">The data record.</param> 
        /// <param name="column">The column.</param> 
        /// <returns></returns>
        public static bool IsUndefinedOrDBNull(this IDataRecord dataRecord, String column)
        {
            bool result = false;
            try
            {
                if (dataRecord.IsDBNull(column)) result = true;
            }
            catch
            {
                result = true;
        ...
        public static T MapType<T>(this IDataRecord record) where T : class, new()
        {
            ...
            {
                if (record.HasColumn(property.Name) && !record.IsUndefinedOrDBNull(property.Name))
